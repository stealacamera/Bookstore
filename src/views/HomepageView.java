...
public class HomepageView extends BaseView {
	...
	private void showStockWarning() {
		if(controller.getAccessLvl() == 2) {
			ArrayList<String> bookTitles = controller.getLowStockBooks();
	...
	private void createLayout() {	
		Text greetingText = new Text("Welcome back, "), usernameText = new Text(controller.getUsername());
	...
	private FlowPane createButtons() {
		...
		Map<Role, Boolean> userPermissionStatus = controller.getUserPermissionStatus();
