...
public class TestBookExpensesViewNeighborhood extends TestNeighborHoodBase {
	...
	static void setUp() {
		...
		billService = new BillService(new BillRepository(Utils.testingUserDataDirPath, context));
		bookPurchaseService = new BookPurchaseService(new BookPurchaseRepository(Utils.testingUserDataDirPath, context));
