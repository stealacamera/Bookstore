...
public class TestHomepageViewNeighborhood extends TestNeighborHoodBase {	
	...
	static void setUp() {
		...
		bookService = new BookInventoryService(new BookInventoryRepository(Utils.testingUserDataDirPath, dbContext));
		...
		ICategoryService categoryService = new CategoryService(new CategoryRepository(Utils.testingUserDataDirPath, dbContext));
...
//		int accessLevel;
//		
//		if(!test.getDisplayName().contains("testHomeActionButtons")) {
//			if(loggedInUser.getAccessLvl() == 2)
//				return;
//			
//			accessLevel = 2;
//		} else {
//			if(test.getTags().contains("LibrarianUser"))
//				accessLevel = 1;
//			else if(test.getTags().contains("ManagerUser"))
//				accessLevel = 2;
//			else
//				accessLevel = 3;
//		}
